...
export default function SuperDelecious() {
  const recipes = getRecipes();

  const topRankedRecipe = recipes
    .filter((recipe) => recipe.rating && recipe.rating.average_rating != null)
